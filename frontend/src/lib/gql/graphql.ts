...
export type PermissionTraceEntry = {
  ...
  rolePosition: Scalars['Int']['output'];
};
...
export type PermissionInspectorQuery = { __typename?: 'Query', permissionExplanation: Array<{ __typename?: 'PermissionExplanation', permission: string, state: PermissionDecisionKind, decidedAt?: PermissionLevel | null, decidedByRole?: string | null, trace: Array<{ __typename?: 'PermissionTraceEntry', level: PermissionLevel, roleName: string, rolePosition: number, decision: PermissionDecisionKind, applied: boolean }> }> };
