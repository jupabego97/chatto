...
export enum BotTokenExpiryPreset {
...
export type CreateBotTokenInput = {
  ...
  botUserId: Scalars['ID']['input'];
  /** Custom expiration timestamp. Required when `expiry` is `CUSTOM`. */
  customExpiresAt?: InputMaybe<Scalars['Time']['input']>;
...
export type CreatedBotToken = {
  __typename?: 'CreatedBotToken';
...
export type Mutation = {
  ...
  createBotToken: CreatedBotToken;
  /**
  ...
  revokeBotToken: Scalars['Boolean']['output'];
  /**
...
/** Root mutation type for modifying data. */
export type MutationCreateBotTokenArgs = {
...
/** Root mutation type for modifying data. */
export type MutationRevokeBotTokenArgs = {
...
/** Root query type for fetching data. */
export type QueryBotTokensArgs = {
  botUserId: Scalars['ID']['input'];
};
...
export type RevokeBotTokenInput = {
...
export type Viewer = {
  ...
  canCreateBots: Scalars['Boolean']['output'];
  /** Whether the viewer can manage bot accounts owned by other users. */
  canManageBots: Scalars['Boolean']['output'];
...
export type UserAvatarUserFragment = { __typename?: 'User', id: string, login: string, displayName: string, isBot: boolean, deleted: boolean, avatarUrl?: string | null, presenceStatus: PresenceStatus } & { ' $fragmentName'?: 'UserAvatarUserFragment' };
...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanAttach: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, viewerCanBanRoomMembers: boolean } | null, server: { __typename?: 'Server', viewerCanManageRooms: boolean, profile: { __typename?: 'ServerProfile', name: string } } };
...
export type BotAccountsAdminQueryVariables = Exact<{ [key: string]: never; }>;


export type BotAccountsAdminQuery = { __typename?: 'Query', bots: Array<{ __typename?: 'User', id: string, login: string, displayName: string, botOwner?: { __typename?: 'User', id: string, login: string, displayName: string } | null }> };

export type BotTokenListQueryVariables = Exact<{
  botUserId: Scalars['ID']['input'];
}>;


export type BotTokenListQuery = { __typename?: 'Query', botTokens: Array<{ __typename?: 'BotToken', id: string, name: string, createdAt: any, expiresAt?: any | null, lastUsedAt?: any | null, revokedAt?: any | null, revokeReason?: string | null, createdBy?: { __typename?: 'User', id: string, login: string, displayName: string } | null, revokedBy?: { __typename?: 'User', id: string, login: string, displayName: string } | null }> };

export type CreateBotAccountMutationVariables = Exact<{
  input: CreateBotInput;
}>;


export type CreateBotAccountMutation = { __typename?: 'Mutation', createBot: { __typename?: 'User', id: string, login: string, displayName: string, botOwner?: { __typename?: 'User', id: string, login: string, displayName: string } | null } };

export type CreateBotApiTokenMutationVariables = Exact<{
  input: CreateBotTokenInput;
}>;


export type CreateBotApiTokenMutation = { __typename?: 'Mutation', createBotToken: { __typename?: 'CreatedBotToken', secret: string, token: { __typename?: 'BotToken', id: string, name: string, createdAt: any, expiresAt?: any | null, lastUsedAt?: any | null, revokedAt?: any | null, revokeReason?: string | null, createdBy?: { __typename?: 'User', id: string, login: string, displayName: string } | null, revokedBy?: { __typename?: 'User', id: string, login: string, displayName: string } | null } } };

export type RevokeBotApiTokenMutationVariables = Exact<{
  input: RevokeBotTokenInput;
}>;


export type RevokeBotApiTokenMutation = { __typename?: 'Mutation', revokeBotToken: boolean };
...
export type ServerAdminMembersQuery = { __typename?: 'Query', server: { __typename?: 'Server', roles: Array<{ __typename?: 'Role', name: string, displayName: string }>, members: { __typename?: 'ServerMembersConnection', totalCount: number, hasMore: boolean, users: Array<{ __typename?: 'User', id: string, login: string, displayName: string, isBot: boolean, avatarUrl?: string | null, roles: Array<string>, createdAt?: any | null }> } } };
...
export type SpaceMemberDetailsQuery = { __typename?: 'Query', user?: { __typename?: 'User', lastLoginChange?: any | null } | null, server: { __typename?: 'Server', viewerCanAssignRoles: boolean, viewerCanManageRoles: boolean, viewerCanManageUserPermissions: boolean, availablePermissions: Array<string>, roles: Array<{ __typename?: 'Role', name: string, displayName: string, position: number, permissions: Array<string>, permissionDenials: Array<string> }>, member?: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, isBot: boolean, roles: Array<string>, botOwner?: { __typename?: 'User', id: string, login: string, displayName: string } | null } | null } };
...
export const BotAccountsAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"BotAccountsAdmin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bots"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"botOwner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]}}]} as unknown as DocumentNode<BotAccountsAdminQuery, BotAccountsAdminQueryVariables>;
export const BotTokenListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"BotTokenList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"botUserId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"botTokens"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"botUserId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"botUserId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastUsedAt"}},{"kind":"Field","name":{"kind":"Name","value":"revokedAt"}},{"kind":"Field","name":{"kind":"Name","value":"revokeReason"}},{"kind":"Field","name":{"kind":"Name","value":"createdBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"revokedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]}}]} as unknown as DocumentNode<BotTokenListQuery, BotTokenListQueryVariables>;
export const CreateBotAccountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateBotAccount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateBotInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createBot"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"botOwner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]}}]} as unknown as DocumentNode<CreateBotAccountMutation, CreateBotAccountMutationVariables>;
export const CreateBotApiTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateBotApiToken"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateBotTokenInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createBotToken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"secret"}},{"kind":"Field","name":{"kind":"Name","value":"token"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastUsedAt"}},{"kind":"Field","name":{"kind":"Name","value":"revokedAt"}},{"kind":"Field","name":{"kind":"Name","value":"revokeReason"}},{"kind":"Field","name":{"kind":"Name","value":"createdBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"revokedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]}}]}}]} as unknown as DocumentNode<CreateBotApiTokenMutation, CreateBotApiTokenMutationVariables>;
export const RevokeBotApiTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RevokeBotApiToken"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RevokeBotTokenInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"revokeBotToken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<RevokeBotApiTokenMutation, RevokeBotApiTokenMutationVariables>;
