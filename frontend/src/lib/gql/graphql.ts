...
export type SpaceMemberDetailsQuery = { __typename?: 'Query', viewer?: { __typename?: 'Viewer', user: { __typename?: 'User', id: string, roles: Array<string> } } | null, user?: { __typename?: 'User', lastLoginChange?: any | null } | null, server: { __typename?: 'Server', viewerCanAssignRoles: boolean, viewerCanManageRoles: boolean, availablePermissions: Array<string>, roles: Array<{ __typename?: 'Role', name: string, displayName: string, position: number, permissions: Array<string>, permissionDenials: Array<string> }>, member?: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, presenceStatus: PresenceStatus, roles: Array<string> } | null }, admin?: { __typename?: 'AdminQueries', userSuspensions: Array<{ __typename?: 'UserSuspension', id: string, userId: string, reason: string, createdAt: any, expiresAt?: any | null }> } | null };
