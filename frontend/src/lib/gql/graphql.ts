...
/** Admin-console query namespace. Returns null unless the viewer is authenticated. */
export type AdminQueriesRoomArgs = {
  roomId: Scalars['ID']['input'];
};
...
export type Mutation = {
  ...
  /** Update a room's Markdown-formatted in-room information. Requires room.manage permission. */
...
/** Root mutation type for modifying data. */
export type MutationUpdateRoomInformationArgs = {
  input: UpdateRoomInformationInput;
};
...
export type Room = {
  ...
  id: Scalars['ID']['output'];
  /**
   * Markdown-formatted in-room information. Returned only to room members and
   * viewers who can manage this room.
   */
...
/** Event: A room's Markdown-formatted in-room information was changed. */
export type RoomInformationChangedEvent = {
...
export type UpdateRoomInformationInput = {
...
export type MyServerEventsSubscription = { __typename?: 'Subscription', myEvents: { __typename?: 'Event', id: string, createdAt: any, actorId?: string | null, actor?: (
      ...
      | { __typename: 'RoomInformationChangedEvent', roomId: string }
...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, information?: string | null, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, viewerCanBanRoomMembers: boolean, members: { __typename?: 'RoomMembersConnection', totalCount: number, hasMore: boolean, users: Array<(
        { __typename?: 'User' }
        & { ' $fragmentRefs'?: { 'UserAvatarUserFragment': UserAvatarUserFragment } }
...
export type AdminRoomDetailQueryVariables = Exact<{
  roomId: Scalars['ID']['input'];
}>;


export type AdminRoomDetailQuery = { __typename?: 'Query', admin?: { __typename?: 'AdminQueries', room?: { __typename?: 'Room', id: string, name: string, description?: string | null, information?: string | null } | null } | null };

export type AdminUpdateRoomDetailsMutationVariables = Exact<{
  input: UpdateRoomInput;
}>;


export type AdminUpdateRoomDetailsMutation = { __typename?: 'Mutation', updateRoom: { __typename?: 'Room', id: string, name: string, description?: string | null } };

export type AdminUpdateRoomInformationMutationVariables = Exact<{
  input: UpdateRoomInformationInput;
}>;


export type AdminUpdateRoomInformationMutation = { __typename?: 'Mutation', updateRoomInformation: { __typename?: 'Room', id: string, information?: string | null } };
...
export const AdminRoomDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminRoomDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"roomId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"admin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"room"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"roomId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"roomId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"information"}}]}}]}}]}}]} as unknown as DocumentNode<AdminRoomDetailQuery, AdminRoomDetailQueryVariables>;
export const AdminUpdateRoomDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdminUpdateRoomDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRoomInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRoom"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<AdminUpdateRoomDetailsMutation, AdminUpdateRoomDetailsMutationVariables>;
export const AdminUpdateRoomInformationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdminUpdateRoomInformation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRoomInformationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRoomInformation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"information"}}]}}]}}]} as unknown as DocumentNode<AdminUpdateRoomInformationMutation, AdminUpdateRoomInformationMutationVariables>;
