# ADR-040: Bot Accounts as User Accounts with Dedicated API Tokens
...
- **Existing RBAC remains the source of truth.** A bot can do whatever its roles and overrides allow, and nothing more.
