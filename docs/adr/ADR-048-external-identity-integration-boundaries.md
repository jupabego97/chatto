# ADR-048: External Identity Integration Boundaries

**Date:** 2026-05-19

## Context

Chatto supports authentication through external identity providers — OIDC, Goth-backed OAuth providers, AT Protocol, and likely more in the future. Each integration raises two recurring questions:
