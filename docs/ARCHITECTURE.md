...
Key files: [`cli/internal/core/core.go`](../cli/internal/core/core.go), [`cli/internal/events/`](../cli/internal/events/), [`cli/internal/runtimeunit/`](../cli/internal/runtimeunit/), [`cli/internal/connectapi/`](../cli/internal/connectapi/), [`cli/internal/http_server/connect.go`](../cli/internal/http_server/connect.go), [`cli/internal/http_server/metrics.go`](../cli/internal/http_server/metrics.go), [`cli/internal/exporter/`](../cli/internal/exporter/), [`proto/chatto/core/v1/`](../proto/chatto/core/v1/), [`proto/chatto/api/v1/`](../proto/chatto/api/v1/), [`proto/chatto/admin/v1/`](../proto/chatto/admin/v1/), [`proto/chatto/realtime/v1/`](../proto/chatto/realtime/v1/)
...
| `/api/connect/chatto.admin.v1.AdminMemberService/UpdateUser`                                   | `AdminMemberService`             | `UpdateUser`                    | Authenticated; self-target or requires `role.assign`.                                                                                                              | Update a user's login and/or display name as an admin action.                                                                                                                                          |
| `/api/connect/chatto.admin.v1.AdminMemberService/ClearUsernameCooldown`                        | `AdminMemberService`             | `ClearUsernameCooldown`         | Authenticated; self-target or requires `role.assign`.                                                                                                              | Clear a user's self-service username-change cooldown.                                                                                                                                                  |
