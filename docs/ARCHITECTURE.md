...
| `/api/connect/chatto.api.v1.UserService/GetUserByLogin`                                      | `UserService`                    | `GetUserByLogin`                | Authenticated; returns an empty response when not found.                        | Read one public user profile by login identifier.                                             |
