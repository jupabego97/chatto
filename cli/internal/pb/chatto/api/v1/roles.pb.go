...
const file_chatto_api_v1_roles_proto_rawDesc = "" +
	...
	"\x04role\x18\x01 \x01(\v2\x13.chatto.api.v1.RoleR\x04role\"\xb6\x01\n" +
	...
	"\x04role\x18\x01 \x01(\v2\x13.chatto.api.v1.RoleR\x04role\"0\n" +
	...
	"\n" +
	"role_names\x18\x01 \x03(\tB\f\xbaH\t\x92\x01\x06\"\x04r\x02\x10\x01R\troleNames\"A\n" +
	"\x14ReorderRolesResponse\x12)\n" +
	"\x05roles\x18\x01 \x03(\v2\x13.chatto.api.v1.RoleR\x05roles2\xf9\x03\n" +
	"\vRoleService\x12N\n" +
	"\tListRoles\x12\x1f.chatto.api.v1.ListRolesRequest\x1a .chatto.api.v1.ListRolesResponse\x12H\n" +
	"\aGetRole\x12\x1d.chatto.api.v1.GetRoleRequest\x1a\x1e.chatto.api.v1.GetRoleResponse\x12Q\n" +
	"\n" +
	"CreateRole\x12 .chatto.api.v1.CreateRoleRequest\x1a!.chatto.api.v1.CreateRoleResponse\x12Q\n" +
	"\n" +
	"UpdateRole\x12 .chatto.api.v1.UpdateRoleRequest\x1a!.chatto.api.v1.UpdateRoleResponse\x12Q\n" +
	"\n" +
	"DeleteRole\x12 .chatto.api.v1.DeleteRoleRequest\x1a!.chatto.api.v1.DeleteRoleResponse\x12W\n" +
	"\fReorderRoles\x12\".chatto.api.v1.ReorderRolesRequest\x1a#.chatto.api.v1.ReorderRolesResponseB\xa6\x01\n" +
