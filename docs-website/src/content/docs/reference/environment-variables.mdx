...
<EnvVar name="CHATTO_AUTH_BOT_TOKEN_MAX_TTL" toml="auth.bot_token_max_ttl" default="0">
  Optional maximum lifetime for bot API tokens. `0` or unset allows indefinite bot tokens; any positive duration disables indefinite tokens and requires 30/90/365-day and custom expirations to fit within the configured maximum.
</EnvVar>
