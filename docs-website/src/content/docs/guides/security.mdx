...
| ----------------------------------- | ------------------------------------------- | -------------- |
| Per-user KEKs and wrapped DEK records | `ENCRYPTION_KEYS` (NATS KV)               | No (export separately) |
