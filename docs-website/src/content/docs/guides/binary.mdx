...
Run these commands on the server host as a user that can access the socket, or use SSH/`sudo`/systemd service permissions to cross that local boundary intentionally.
