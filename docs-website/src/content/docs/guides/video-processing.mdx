...
<Aside>
  When video processing is disabled (the default), uploaded videos are still stored and served as regular file attachments. Enabling processing adds transcoding, adaptive playback, and thumbnail generation.
</Aside>
