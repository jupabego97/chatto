...
<Aside type="tip">
  Without the key import step, the instance will function normally — users can log in, browse spaces, and send new messages. Only previously encrypted message bodies will appear as unavailable.
</Aside>
