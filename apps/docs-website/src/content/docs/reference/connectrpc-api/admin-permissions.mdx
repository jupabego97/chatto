...
| --- | --- | --- |
| `role_name` | `string` | Stable role name. |
| `decisions` | repeated [`ScopedPermissionDecision`](/reference/connectrpc-api/types/#chatto-admin-v1-ScopedPermissionDecision) | Permission decisions keyed by permission and scope. |
