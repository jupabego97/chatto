...
<a id="chatto-api-v1-UserPresenceSummary"></a>
...
| `profile` | [`UserPresenceSummary`](#chatto-api-v1-UserPresenceSummary) | Public profile and live presence fields for the authenticated user. |
...
<a id="chatto-api-v1-AdminEventLogEntry"></a>
...
| `user` | [`UserSummary`](#chatto-api-v1-UserSummary) | Public identity fields for this user. |
...
| Field | Type | Description |
| --- | --- | --- |
| `users` | map&lt;`string`, [`UserSummary`](#chatto-api-v1-UserSummary)&gt; | Users keyed by user ID. |
...
| `actor` | [`UserPresenceSummary`](#chatto-api-v1-UserPresenceSummary) | User who triggered the notification, when still resolvable. |
...
<a id="chatto-api-v1-PermissionTraceEntry"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `level` | [`PermissionDecisionLevel`](#chatto-api-v1-PermissionDecisionLevel) | Level at which this decision was observed. |
| `role_name` | `string` | Role name or policy marker that produced the decision. |
| `decision` | [`PermissionDecision`](#chatto-api-v1-PermissionDecision) | Decision observed at this trace step. |
...
| Field | Type | Description |
| --- | --- | --- |
| `user` | [`UserPresenceSummary`](#chatto-api-v1-UserPresenceSummary) | Participant user. |
