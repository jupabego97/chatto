...
| `can_assign_roles` | `bool` | Whether the user may assign and revoke roles for users. |
| `can_admin_manage_accounts` | `bool` | Whether the user may perform account lifecycle and recovery actions for users. |
...
<a id="chatto-api-v1-PendingExternalIdentity"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `kind` | [`ExternalIdentityFlowKind`](#chatto-api-v1-ExternalIdentityFlowKind) | Pending flow kind. |
...
<a id="chatto-api-v1-ServerMemberProfile"></a>
...
<a id="chatto-api-v1-ServerViewerPermission"></a>

### ServerViewerPermission
...
| `granted` | `bool` | Whether the permission is currently granted to the viewer. |
...
| Field | Type | Description |
| --- | --- | --- |
| `permissions` | repeated [`ServerViewerPermission`](#chatto-api-v1-ServerViewerPermission) | One row per permission known to the server. |
...
<a id="chatto-api-v1-ExternalIdentityFlowKind"></a>
