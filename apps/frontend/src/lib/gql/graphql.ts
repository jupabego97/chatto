...
export type NotificationCreatedEvent = {
  ...
  roomId: Scalars['ID']['output'];
  /** Whether clients should update notification state without playing an alert sound. */
...
/**
 * Event: A user's custom status was cleared.
 * Delivered from the durable EVT user aggregate.
 */
export type UserCustomStatusClearedEvent = {
  __typename?: 'UserCustomStatusClearedEvent';
  /** The user whose status was cleared. */
  userId: Scalars['ID']['output'];
};

/**
 * Event: A user's custom status was set or replaced.
 * Delivered from the durable EVT user aggregate.
 */
export type UserCustomStatusSetEvent = {
  __typename?: 'UserCustomStatusSetEvent';
  /** The newly active custom status. */
...
export type LoadCurrentUserQuery = { __typename?: 'Query', viewer?: { __typename?: 'Viewer', user: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, presenceStatus: PresenceStatus, hasVerifiedEmail: boolean, customStatus?: { __typename?: 'CustomUserStatus', emoji: string, text: string, expiresAt?: any | null } | null, settings?: { __typename?: 'UserSettings', timezone?: string | null, timeFormat: TimeFormat } | null } } | null };
...
export type UserAvatarUserFragment = { __typename?: 'User', id: string, login: string, displayName: string, deleted: boolean, avatarUrl?: string | null, presenceStatus: PresenceStatus, customStatus?: { __typename?: 'CustomUserStatus', emoji: string, text: string, expiresAt?: any | null } | null } & { ' $fragmentName'?: 'UserAvatarUserFragment' };
...
export type MyServerEventsSubscription = { __typename?: 'Subscription', myEvents: { __typename?: 'Event', id: string, createdAt: any, actorId?: string | null, actor?: (
      ...
      | { __typename: 'NotificationCreatedEvent', notificationId: string, roomId: string, eventId?: string | null, inReplyToId?: string | null, silent: boolean }
      ...
      | { __typename: 'UserCreatedEvent' }
      | { __typename: 'UserCustomStatusClearedEvent', userId: string }
      | { __typename: 'UserCustomStatusSetEvent', userId: string, setCustomStatus: { __typename?: 'CustomUserStatus', emoji: string, text: string, expiresAt?: any | null } }
      | { __typename: 'UserDeletedEvent' }
